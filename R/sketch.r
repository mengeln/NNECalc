...
sketch <- function () {
  ...
  library(plyr)
  fullSWAMPdata$StationCode <- as.character(fullSWAMPdata$StationCode)
  fullSWAMPdata$SampleDate <- as.character(fullSWAMPdata$SampleDate)
  fullSWAMPdata$CollectionTime <- as.character(fullSWAMPdata$CollectionTime)
